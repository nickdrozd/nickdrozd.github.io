...
*All that's left is "AI can never come up with an original artistic / scientific idea". Except, this is not true anymore.* [[https://nickdrozd.github.io/2025/10/07/beach-boys-beatles-ai.html][AI-generated music is really starting to hit]], and of course original, compelling images have been old hat for a while now. What about original scientific ideas? Yes, that's starting to happen too.
